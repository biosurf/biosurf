...
# same ensgID than EGFR, different isoform ?
```
...
setwd("../../")
target_essentiality_fun(gene_name_hgnc = "EGFRvIII") # it creates the boxplot in the html and saves it as .pdf in the plot/target_essentiality folder
```
