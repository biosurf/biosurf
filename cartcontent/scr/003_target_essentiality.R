# TARGET ESSENTIALITY
# goal: to create for each gene a table containing the genename, the essentiality scores and the cancer for 
# which the scores are calculated. 
# Each of these tables will be used to create the boxplot for target essentiality. 
...
# The cell lines are of different cancers. 
...
# in the following code I am verifying that all the NAs in the table are associated to 
# said cell_line. 
...
saveRDS(crispr, file = "cartcontent/results/003_crispr_target_essentiality.rds")
