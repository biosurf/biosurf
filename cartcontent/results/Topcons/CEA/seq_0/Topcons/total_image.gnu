...
set out '/static/tmp/tmp_dneL6z/rst_UxukVO/seq_0///Topcons/total_image.large.png'
set lmargin 13.5
set rmargin 6.5
set tmargin 1.3
...
set object 6 rect from 34.5,33.2 to 141.5,33.4 fc rgb "blue" fs noborder
set object 7 rect from 0.5,32.4 to 34.5,33.4 fc rgb "black" fs noborder
set object 8 rect from 0.5,36.2 to 141.5,36.4 fc rgb "blue" fs noborder
set object 9 rect from 34.5,39.2 to 141.5,39.4 fc rgb "blue" fs noborder
set object 10 rect from 0.5,38.4 to 34.5,39.4 fc rgb "black" fs noborder
set object 11 rect from 34.5,42.2 to 141.5,42.4 fc rgb "blue" fs noborder
set object 12 rect from 0.5,41.4 to 34.5,42.4 fc rgb "black" fs noborder
set object 13 rect from 0.5,45.2 to 141.5,45.4 fc rgb "blue" fs noborder
set object 14 rect from 30.5,48.2 to 141.5,48.4 fc rgb "blue" fs noborder
set object 15 rect from 0.5,47.4 to 30.5,48.4 fc rgb "black" fs noborder
plot '/static/tmp/tmp_dneL6z/rst_UxukVO/seq_0///DG1.txt' axes x1y2 w l t '' lt 3 lw 4
exit
