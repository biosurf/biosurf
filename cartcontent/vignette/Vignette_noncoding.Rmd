...
```{r, fig.cap="Ensembl search results showing the ERBB2 gene entry with gene symbol, Ensembl ID, and brief description.", out.width="100%"}
knitr::include_graphics("vignette/ensembl2.png")
```
...
```{r, fig.cap="Ensembl transcripts table showing protein-coding isoforms with transcript IDs, protein lengths, and UniProt matches.", out.width="100%"}
knitr::include_graphics("vignette/ensembl3.png")
```
...
- Above the transcripts table, click on the Excel icon to download the table and use it for further analyses

# Find Isoform Sequences: UniProt
...
knitr::include_graphics("vignette/Uniprot1.png")
```
...
# Find Subcellular Localization with DeepLoc2.1
...
- DeepLoc 2.1 predicts multi-label subcellular localization and membrane association for eukaryotic proteins
...
- The prediction typically takes a few seconds to complete
...
knitr::include_graphics("vignette/deeploc2.png")
```


The results page contains several key sections for each analysed isoform: 
...
# Find Target Expression Across Tissues (TCGA and GTEx): Xena Browser
...
**Note**: This analysis examines gene-level expression; isoform-specific expression analysis requires computational approaches (refer to coding vignette for advanced methods).
...
knitr::include_graphics("vignette/xena1.png")
```
...
knitr::include_graphics("vignette/xena3.png")
```
...
# Figure Out Membrane Topology: DeepTMHMM
...
- Alternatively, use the BioLib version at https://dtu.biolib.com/DeepTMHMM -> add or not? 
...
knitr::include_graphics("vignette/deeptmhmm0.png")
```
...
knitr::include_graphics("vignette/deeptmhmm2.png")
```
...
knitr::include_graphics("vignette/deeptmhmm3.png")
```
...
knitr::include_graphics("vignette/deeptmhmm1.png")
```
...
knitr::include_graphics("vignette/pdb1.png")
```
...
knitr::include_graphics("vignette/pdb2.png")
```
...
knitr::include_graphics("vignette/af1.png")
```
...
knitr::include_graphics("vignette/af2.png")
```
